...
-(void)awakeFromNib
{
	...
	[self setThumbImage:[UIImage imageNamed:@"switch_thumb.png"] forState:UIControlStateNormal];
	[self setMinimumTrackImage:[UIImage imageNamed:@"switch_bg.png"] forState:UIControlStateNormal];
	[self setMaximumTrackImage:[UIImage imageNamed:@"switch_bg.png"] forState:UIControlStateNormal];
